...
namespace AI.Skymind.SKIL.Client
{
    ...
    public class Configuration : IReadableConfiguration
    {
        ...
        {
            UserAgent = "Swagger-Codegen/1.0.3-1/csharp";
            BasePath = "https://localhost:9008/endpoints";
        ...
        public Configuration(
            ...
            string basePath = "https://localhost:9008/endpoints") : this()
        {
        ...
        public Configuration(
            ...
            int timeout = 100000,
            string userAgent = "Swagger-Codegen/1.0.3-1/csharp"
        ...
        {
            String report = "C# SDK (AI.Skymind.SKIL) Debug Report:\n";
            report += "    OS: " + System.Environment.OSVersion + "\n";
            report += "    .NET Framework Version: " + System.Environment.Version  + "\n";
            report += "    Version of the API: 1.0.3\n";
            report += "    SDK Package Version: 1.0.3-1\n";
