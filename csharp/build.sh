...
${nuget_cmd} install src/AI.Skymind.SKIL/packages.config -o packages;
...
echo "[INFO] Run 'mcs' to build bin/AI.Skymind.SKIL.dll"
mcs -langversion:${langversion} -sdk:${sdk} -r:bin/Newtonsoft.Json.dll,bin/JsonSubTypes.dll,\
bin/RestSharp.dll,\
System.ComponentModel.DataAnnotations.dll,\
System.Runtime.Serialization.dll \
-target:library \
-out:bin/AI.Skymind.SKIL.dll \
-recurse:'src/AI.Skymind.SKIL/*.cs' \
-doc:bin/AI.Skymind.SKIL.xml \
-platform:anycpu
...
then
  ...
  echo "[INFO] bin/AI.Skymind.SKIL.dll was created successfully"
fi
